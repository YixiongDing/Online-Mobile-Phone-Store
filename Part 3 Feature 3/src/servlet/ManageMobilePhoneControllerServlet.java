...
/**
 * Servlet implementation class ManageMobilePhoneControllerServlet
 */
@WebServlet("/ManageMobilePhoneControllerServlet")
public class ManageMobilePhoneControllerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ManageMobilePhoneControllerServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("Hello from GET method in ManageMobilePhoneControllerServlet");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("Hello from POST method in ManageMobilePhoneControllerServlet");
		MobilePhoneService ms= new MobilePhoneService();		
