...
public class CustomerMapper extends DataMapper {
	...
	/**
	 * A method to insert customer object into database
	...
	/**
	 * A method to delete customer object into database
	 * @param DomainObject obj
	 * @return boolean
	 * @throws Exception e
	 */
	...
	/**
	 * A method to update customer object into database
	 * @param DomainObject obj
	 * @return boolean
	 * @throws Exception e
	 */
	...
	/**
	 * A method to find customer in database by customer id 
	...
	/**
	 * A method to find customer in database by customer email
	 * @param Customer customer
	 * @return List<Customer> result
	 * @throws Exception e
	 */
	...
	/**
	 * A method to find all customers in database 
	 * @return List<Customer> result
	 * @throws Exception e
	 */
	...
	/**
	 * A static method to find customer in database by customer name 
	...
	public static Customer getCustomerByName(String username) {
		...
		try {
			...
			while(result.next()) {
				...
				customer.setUserType(result.getString(5)); 
	...
	/**
	 * A static method to find customer in database by customer id 
	 * @param String username
	 * @return Customer customer
	 * @throws Exception e
	 */
